...
$dataabsenonly = query("SELECT user.username, detail.nama, detail.nip, absensi.tanggal_absen
                    ...
                    WHERE user.id = '$idkepsek' ORDER BY tanggal_absen DESC");
...
$mpdf->WriteHTML($html);
$mpdf->Output('laporan-absensi-KEPALASEKOLAH_SELF-' . $now . '.pdf', \Mpdf\Output\Destination::INLINE);
