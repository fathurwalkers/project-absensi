...
//     $query = "SELECT * FROM user WHERE username = '$username' AND password = '$password' LIMIT 1 AND role_id = '2'";

//     $run = mysqli_query($conn, $query);
//     $result = mysqli_fetch_assoc($run);

//     if (!empty($result)) {
//         $_SESSION["dataguru"] = $result;
//         $_SESSION["guru"] = true;
//         header("Location: dashboard/guru/home.php");
//         exit;
//     }
// }
...
if (isset($_POST['loginguru'])) {
    ...
    $query = "SELECT * FROM user WHERE username = '{$username}' AND password = '$password' AND role_id = '2' LIMIT 1";
